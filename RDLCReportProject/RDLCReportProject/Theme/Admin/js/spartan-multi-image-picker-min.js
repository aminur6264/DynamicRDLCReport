    ...
    $.fn.spartanMultiImagePicker = function (options) {
        ...
        function addRow(settings, el) {
            ...
            var template = `<div class="${groupClassName} spartan_item_wrapper" data-spartanindexrow="${count}" style="margin-bottom : 20px; ">` +
                ...
                `<a href="javascript:void(0)" data-spartanindexremove="${count}" style="position: absolute !important; right : 3px; top: 3px; display : none; background : #ED3C20; border-radius: 3px; width: 30px; height: 30px; line-height : 30px; text-align: center; text-decoration : none; color : #FFF;" class="spartan_remove_row"><i class="glyphicon glyphicon-remove-circle"></i></a>` +
                ...
                `<img name="images" style="width: 100%; vertical-align: middle; display:none;" class="img_" data-spartanindeximage="${count}">` +
